...
Partly hide some text until the user clicks a button.
...
* Initialize the ShowMore function in document ready or window load by calling mgShowMore() function.

### CSS and JS References

#### JS:

* https://unisdr.github.io/undrr-mangrove/js/show-more.min.js
