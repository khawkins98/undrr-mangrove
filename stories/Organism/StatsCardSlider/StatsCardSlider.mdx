...
import * as StatsCardSliderStories from './StatsCardSlider.stories';
...
<Meta of={StatsCardSliderStories} />
...
* Add following JS files too
  ...
  * https://unisdr.github.io/undrr-mangrove/js/swiper.min.js
* Refer [this document](https://github.com/unisdr/undrr-mangrove/wiki/Swiper-documentation) for Swiper integration & options
